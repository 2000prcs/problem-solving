...
const canCompleteCircuit = (gas, cost) => {
    ...
    // The intuition here is whether you can find such a station that starting from it would cover the lack of fuel you had seen so far.
    let startingStation = null;
    let totalTank = 0;
    let currentTank = 0;
